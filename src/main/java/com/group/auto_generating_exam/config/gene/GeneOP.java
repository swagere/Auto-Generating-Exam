...
//                questions[i].id = i;
//
//                questions[i].kind = myRand.nextInt(10);
//                questions[i].hard = Math.abs(myRand.nextInt(10)/10.0 - 0.01);
//                questions[i].diff = Math.abs(myRand.nextInt(10)/10.0 - 0.01);
//                questions[i].score = myRand.nextInt(19) + 1;
//                questions[i].chapter = myRand.nextInt(20);
//                questions[i].importance = myRand.nextInt(3);
//            }
//        }
//
